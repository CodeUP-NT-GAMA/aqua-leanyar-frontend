        ...
        <AppBackground>
            <ScrollView contentContainerStyle={styles.container}>
                <TouchableOpacity onPress={handleImagePick}>
                    <Image source={profileImage ? {uri: profileImage} : require('@assets/profile_logo.png')}
                ...
                <Modal visible={isNameEditVisible} transparent={true}>
                    <View style={styles.modalContainer}>
                        <TextInput label="First Name" value={newFirstName} onChangeText={setNewFirstName}
                                   style={styles.input}/>
                        <TextInput label="Last Name" value={newLastName} onChangeText={setNewLastName}
                                   style={styles.input}/>
                ...
                <Button mode="contained" onPress={handlePurchaseHistory} style={styles.actionButton}>Purchase
                    History</Button>
                <Button mode="contained" onPress={() => setPasswordModalVisible(true)} style={styles.actionButton}>Change
                    Password</Button>
